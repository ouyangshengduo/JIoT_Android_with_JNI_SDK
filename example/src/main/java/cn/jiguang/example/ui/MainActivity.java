...
import cn.jiguang.iot.bean.MsgDeliverRsp;
...
public class MainActivity extends BaseActivity implements JclientHandleCallback, JclientMessageCallback, View.OnClickListener {
    ...
    private void initData() {
        ...
        etProductKey.setText(Constant.DEFAULT_PRODUCT_KEY);
        etDeviceName.setText(Constant.DEFAULT_DEVICE_NAME);
        etDeviceSecret.setText(Constant.DEFAULT_DEVICE_SECRET);
    ...
    private void initView() {
        ...
        //获取连接状态
        Button btnGetConnStatus = findViewById(R.id.btn_get_conn_status);
        //上报设备属性
        Button btnReportProperty = findViewById(R.id.btn_report_property);
        //上报设备事件
        Button btnReportEvent = findViewById(R.id.btn_report_event);
        //上报设备版本
        Button btnReportVersion = findViewById(R.id.btn_report_version);
        ...
        llDeviceInfo = findViewById(R.id.ll_device_info);
        etPropertyEventName = findViewById(R.id.et_property_event_name);
        etValueContent = findViewById(R.id.et_value_content);
        ...
        spinner.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
                                              ...
                                              public void onItemSelected(AdapterView<?> parent, View view, int position, long id) {
                                                  ...
                                                  if(null != jiotClientApi){
                                                      jiotClientApi.jiotSetLogLevel(3);
                                                  }
                                              }
