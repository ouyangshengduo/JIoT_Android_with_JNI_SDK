...
class Constant {
     ...
     * 默认产品key
     */
    static final String DEFAULT_PRODUCT_KEY = DEBUG ? "d8ede4ec19bae0fe8848643b" : "";
    /**
     * 默认产品名称
     */
    static final String DEFAULT_DEVICE_NAME = DEBUG ? "senduo_test_device" : "";
    /**
     * 默认设备密钥
     */
    static final String DEFAULT_DEVICE_SECRET = DEBUG ? "08569d0213176a431cfe5a5b" : "";
    /**
     * 默认设备属性
     */
    static final String DEFAULT_DEVICE_PROPERTY = "senduo_test_property";
    /**
     * 设备上传的内容
     */
    static final String DEFAULT_REPORT_CONTENT = "JIOT FOR TEST";

    static final String DEFAULT_REPORT_VERSION = "1.0.2";
}
