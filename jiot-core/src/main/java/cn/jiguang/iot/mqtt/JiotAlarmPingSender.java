...
public class JiotAlarmPingSender implements MqttPingSender {
    ...
    public JiotAlarmPingSender(Context context) {
    ...
    @Override
    public void start() {
        String action = "Jiot.pingSender" + mComms.getClient().getClientId();
        JiotLogger.d("Register JiotAlarmPingSenderReceiver to Context " + action);
